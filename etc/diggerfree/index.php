...
-->
	...
	<div class='b3'>
		<form method='post' id='digger'>
			...
			<h4>Positions</h4>
			<div class='bar'>
				<input type='radio' name='position' value='CA' class='digger' /> CA &nbsp;
				<input type='radio' name='position' value='1B' class='digger' /> 1B &nbsp;
				<input type='radio' name='position' value='2B' class='digger' /> 2B &nbsp;
				<input type='radio' name='position' value='3B' class='digger' /> 3B &nbsp;
				<input type='radio' name='position' value='SS' class='digger' /> SS &nbsp;
				<input type='radio' name='position' value='LF' class='digger' /> LF &nbsp;
				<input type='radio' name='position' value='CF' class='digger' /> CF &nbsp;
				<input type='radio' name='position' value='RF' class='digger' /> RF &nbsp;
			</div>
			...
			<h4>Years</h4>
			<div class='bar'>
				<input type='text' name='start' value='1901' class='digger'>
				<input type='text' name='end' value='1995' class='digger'>
			</div>			
...
$(document).ready(function() {
	...
	$(".digger").change(function(e) {
		...
		$.post("/etc/diggerfree/data.php", { data: data }, function(data) {
